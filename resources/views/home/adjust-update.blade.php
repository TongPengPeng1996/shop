...
<center>
      ...
      <form  action="{{ URL('/home/adjust') }}/{{ $list->id }}" method="post" class="form-inline">
       <input type="hidden" name="_token" value="{{ csrf_token() }}">
    <input type="hidden" name="_method" value="put">
          <div class="row cl" style="font-size:18px;">
            收货人姓名：<div><input type="text" name="name" value="{{ $list->name }}"></div>
          </div>

          <div style="height:20px;"></div>

          <div class="row cl" style="font-size:18px;">
            收货人电话：<div><input type="text" name="Telephone" value="{{ $list->Telephone }}"></div>
          </div>

          <div style="height:20px;"></div>

          <div class="row cl" style="font-size:18px;">
          收货地址：<div><input type="text" name="ReceiptAddress" value="{{ $list->ReceiptAddress }}"></div>
          </div>

          <div style="height:20px;"></div>

          <div class="row cl" style="font-size:18px;">
          收货时间：<div><select name="ReceivingTime" value="{{ $list->ReceivingTime }}">

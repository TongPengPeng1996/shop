...
<div class="pd-20">
    ...
    <span class="c-gray en">&gt;</span> <a href="{{ URL('/admin/introduce') }}/create">添加商品</a> </nav>
	<form action="{{ url('/admin/introduce') }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
        <input type='hidden' name='_token' value='{{ csrf_token() }}'>  
		<div class="row cl">
			<label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
			<div class="formControls col-10">
				<input type="text" class="input-text"  style="color:red;" placeholder="" id="" name="GoodsName">
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" name="GoodsPrice" id="" placeholder="" value="" class="input-text" style="width:90%">
				元</div>
			<label class="form-label col-2">商品颜色：</label>
			<div class="formControls col-4">
				<input type="text" name="color" id="" placeholder="" value="" class="input-text" style="width:90%">
				</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<textarea name="descript" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)"></textarea>
		...
		<div class="row cl">
			<div class="col-10 col-offset-2">
                ...
                <a href="{{ URL('/admin/introduce') }} " class="btn btn-default radius">取消</a>
			</div>
		</div>
	</form>
</div>

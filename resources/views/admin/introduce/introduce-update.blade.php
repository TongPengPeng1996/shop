...
<div class="pd-20">
    ...
    <span class="c-gray en">&gt;</span><a href="{{ URL('/admin/introduce') }}"> 商品推荐</a>
    <span class="c-gray en">&gt;</span> <a href="{{ URL('/admin/introduce') }}/{{ $list->id }}/edit">修改商品</a> </nav>
    <form action="{{ URL('/admin/introduce') }}/{{ $list->id }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
        <input type='hidden' name='_token' value='{{ csrf_token() }}'>  
        <input type='hidden' name='_method' value='put'>
        <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{{ $list->GoodsName }}" placeholder="" id="" name="GoodsName">
            ...
            <div class="formControls col-4">
                <input type="text" name="GoodsPrice" id="" placeholder="" value="{{ $list->GoodsPrice }}" class="input-text" style="width:100%">
                </div>
        </div>
        ...
        <div class="row cl">
                ...
                <div class="formControls col-4">
                <input type="text" name="color" id="" placeholder="" value="{{ $list->color }}" class="input-text" style="width:100%">
                </div>
            <div class="row cl">
            
                <br>
            <label class="form-label col-2"><span class="c-red">*</span>商品尺寸：</label>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-10">
                <textarea name="descript" cols="" rows="" class="textarea"  placeholder="说点什么...最少输入10个字符" datatype="*10-100" dragonfly="true" nullmsg="备注不能为空！" onKeyUp="textarealength(this,200)">{{ $list->descript }}</textarea>
                <p class="textarea-numberbar"><em class="textarea-length">0</em>/200</p>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-2">商品图：</label>
            <div class="formControls col-10">
                <div class="uploader-thum-container">
                    ...
                    <!-- </form>  -->
                    <img src="{{ asset('/uploads/') }}/{{ $list->GoodsImage }}" style="width:100px;height:100px;">
                    ...
                    <!-- <input type='submit' value='开始上传' id="btn-star" class="btn btn-default btn-uploadstar radius ml-10"> -->
                </div>
            </div>
        </div>
        ...
        <div class="row cl">
            <div class="col-10 col-offset-2">
                ...
                <a href="{{ URL('/admin/goods/commodity-list') }} " class="btn btn-default radius">取消</a>
            </div>
        </div>
    </form>
</div>
...
<script type="text/javascript" src="{{ asset('/admins/lib/My97DatePicker/WdatePicker.js') }}"></script> 

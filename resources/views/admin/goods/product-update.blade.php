	...
	<form action="{{ URL('/admin/goods/commodity-list') }}/{{ $list->id }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
        ...
        <div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" class="input-text" value="{{ $list->proname }}" placeholder="" id="" name="proname">
		...
		<div class="row cl">
			...
			<div class="formControls col-4">
				<input type="text" name="price" id="" placeholder="" value="{{ $list->price }}" class="input-text" style="width:90%">
				元</div>
			<label class="form-label col-2">商品库存：</label>
			<div class="formControls col-4">
				<input type="text" name="store" id="" placeholder="" value="{{ $list->store }}" class="input-text" style="width:90%">
				件</div>
		</div>

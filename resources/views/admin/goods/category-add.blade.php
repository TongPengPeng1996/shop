...
<body>
<div class="layui-layer-title" style="cursor: move;" move="ok"><a href="{{ URL('/admin/goods/commodity-list') }}">商品管理</a>->添加顶级分类</div>
<div class="pd-20">
<form id="form-member-add" class="form form-horizontal" method="post" action="{{ URl('/admin/categorys') }}">

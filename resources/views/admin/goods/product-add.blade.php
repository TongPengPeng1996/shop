...
<div class="pd-20">
    ...
    <span class="c-gray en">&gt;</span> <a href="{{ URL('/admin/goods/product-add') }}">添加商品</a> </nav>
	<form action="" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">

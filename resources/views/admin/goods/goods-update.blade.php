...
<div class="pd-20">
    ...
    <form action="{{ URL('/admin/goods/goods-detail') }}/{{ $list->id }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4"> 
               ...
               <input type='text' name='name' value="{{ $list->goodsname }}" class="select select-box" disabled = "disabled">
            </div>
        </div>
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-4"> 
                ...
                <input type="text" name="color" class="select-box select" value="{{ $list->color }}">

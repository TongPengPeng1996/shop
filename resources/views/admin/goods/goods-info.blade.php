...
<div class="pd-20">
    ...
    <span class="c-gray en">&gt;</span> <a href="{{ URL('/admin/goods/goods-detail') }}">商品详情</a> </nav>
    <form action="{{ URL('/admin/goods/goods-info') }}/{{ $goods->id }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
        <input type='hidden' name='_token' value='{{ csrf_token() }}'>
        <input type="hidden" name="_method" value="put">
        <!-- <div class="row cl">
            <label class="form-label col-2"><span class="c-red">*</span>商品名称：</label>
            <div class="formControls col-10">
                <input type="text" class="input-text" value="{{ session('msg') }}" style="color:red;" placeholder="" id="" name="proname">
            </div>
        </div> -->
        
        <!-- <div class="row cl">
            <label class="form-label col-4"><span class="c-red">*</span>商品名：{{ $goods->proname }}</label>
            <div class="formControls col-4"> <span class="select-box">
                <select name="cateid" class="select" disabled = "disabled">
                ...
                <input type='text' name='goodsname' value="{{ $goods->proname }}"  class="select" disabled = "disabled">
                </span> 
            </div>
        ...
        <div class="row cl">
            <label class="form-label col-4"><span class="c-red">*</span>商品名：</label>
            <div class="formControls col-4"> 
                <input type='hidden' name="gid" value="{{ $goods->id }}">
                <input type='hidden' name="goodsname" value="{{ $goods->proname }}">
               <input type='text' name='name' value="{{ $goods->proname }}" class="select select-box" disabled = "disabled">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-4"><span class="c-red">*</span>商品尺码：</label>
            <div class="formControls col-4"> <span class="select-box">
        ...
        <div class="row cl">
            <label class="form-label col-4"><span class="c-red">*</span>商品颜色：</label>
            <div class="formControls col-4"> 
                
                <input type="text" name="color" class="select-box select">
        ...
        <div class="row cl">
            <div class="col-4 col-offset-2"  style="margin-left:370px;">

...
<div class="pd-20">
    ...
    <span class="c-gray en">&gt;</span><a href="{{ URL('/admin/brand') }}"> 品牌列表</a>
    <span class="c-gray en">&gt;</span> <a href="{{ URL('/admin/brand') }}/{{ $list->id }}/edit">修改品牌</a> </nav>
	<form action="{{ URL('/admin/brand') }}/{{ $list->id }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
		...
		<div class="row cl">
            <label class="form-label col-4"><span class="c-red">*</span>官网地址 ：</label>
            <div class="formControls col-4">
                <input type="text" class="input-text" value="{{ $list->url }}" style="color:red;" placeholder="请输入url" id="" name="url">
		...
		<div class="row cl">
			<label class="form-label col-4">品牌图片：</label>
			<div class="formControls col-4">
				<div class="uploader-thum-container">
					...
					<div id="filePicker">选择图片</div><br>
					   <img src="{{ URL('/uploads/s_') }}{{ $list->image }}">
				</div>
		...
		<div class="row cl">
			<div class="col-10 col-offset-2" style="margin-left:290px;">

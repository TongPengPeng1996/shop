...
<div class="pd-20">
    ...
    <span class="c-gray en">&gt;</span> <a href="{{ URL('/admin/brand') }}/create">添加品牌</a> </nav>
	<form action="{{ URL('/admin/brand') }}" method="post" class="form form-horizontal" id="form-article-add" name='myfrom' enctype="multipart/form-data">
		...
		<div class="row cl">
            ...
            <div class="formControls col-4">
                <input type="text" class="input-text" value="" style="color:red;" placeholder="请输入url" id="" name="url">
                <span stule="color:red;">
                    @if(session('url'))
                        {{ session('url') }}
                    @endif
                </span>
